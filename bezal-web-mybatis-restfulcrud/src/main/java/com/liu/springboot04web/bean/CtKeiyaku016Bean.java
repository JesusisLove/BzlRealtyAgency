...
public class CtKeiyaku016Bean implements BzlFudousanBean {
    ...
    public String getChukaiCopMngNo() {
        return chukaiCopMngNo;
    }

    public void setChukaiCopMngNo(String chukaiCopMngNo) {
        this.chukaiCopMngNo = chukaiCopMngNo;
    }
